  ...
  return (
    <div className="mt-40">
      ...
      <Head>
        ...
        <meta
          name="description"
          content="Reliance Digital Creative: Work - Thomason Realty Group, a web design project for a start up based company based out of the SF Bay Area. Reliance Digital Creative offers Web Design, SEO, Web Development, Branding, and Content writing services for your business."
        />
